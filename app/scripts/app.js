...
const DATA = {
    results: [
        ...
        { id: "Б", title: "Пытаясь разложить вещи и дела по местам, вы тратите много сил. Но насладиться результатом не удается.", text: "Чтобы не испытывать раздражения от того, что что-то идет не так, научитесь прислушиваться к спонтанным желаниям и не гасить их. А чтобы ничего не беспокоило и не раздражало, используйте <span>дезодорант-антиперспирант Dove Гипоаллергенный</span>, созданный специально для деликатной кожи. 0% спирта, без отдушек и парабенов. Подойдет даже кормящим мамам." },
        { id: "В", title: "С вами удобно всем: близким и друзьям, начальству и коллегам, пассажирам в транспорте. Есть, правда, одна загвоздка: пытаясь угодить каждому, вы забываете о собственных желаниях. ", text: "Учиться отказывать без чувства вины. Начав делать это, вы постепенно вернете себе утраченную легкость. Главное, забыть про извиняющийся тон и помнить, что поход на танцы или в театр – это ваше право. А о том, чтобы вы идеально вышли в свет, позаботится <span>антиперспирант Dove Pro-collagen</span>. Он восстанавливает кожу после бритья уже за 3 дня*, устраняя признаки раздражения.<br><br><span class='small'>*Способствует восстановлению кожи после бритья за 3 дня – значительное сокращение видимых признаков раздражения кожи через 3 дня (клинический тест, Unilever R&D, 2015</span> " }
    ]
};
