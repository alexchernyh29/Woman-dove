...
const DATA = {
    results: [
        ...
        { id: "В", title: "С вами удобно всем: близким и друзьям, начальству и коллегам, пассажирам в транспорте. Есть, правда, одна загвоздка: пытаясь угодить каждому, вы забываете о собственных желаниях. ", text: "Учиться отказывать без чувства вины. Начав делать это, вы постепенно вернете себе утраченную легкость. Главное, забыть про извиняющийся тон и помнить, что поход на танцы или в театр – это ваше право. А о том, чтобы вы идеально вышли в свет, позаботится <span>дезодорант Dove Pro-collagen</span>. Он восстанавливает кожу после бритья уже за 3 дня*, устраняя признаки раздражения.<br><br><span>*Способствует восстановлению кожи после бритья за 3 дня – значительное сокращение видимых признаков раздражения кожи через 3 дня (клинический тест, Unilever R&D, 2015</span> " }
    ]
};
